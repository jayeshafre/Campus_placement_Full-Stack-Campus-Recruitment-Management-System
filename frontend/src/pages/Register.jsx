...
export default function Register() {
  ...
  const inputStyle = {
    ...
    padding: '0.65rem 0.9rem', fontSize: '0.9rem', color: '#1E293B',
      ...
      <div style={{ background: '#FFFFFF', borderRadius: '16px', boxShadow: '0 4px 24px rgba(37,99,235,0.08)', padding: '2.5rem', width: '100%', maxWidth: '440px', border: '1px solid #E2E8F0' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '0.5rem' }}>
            ...
            <input type="password" name="password2" value={formData.password2} onChange={handleChange} required placeholder="Repeat password"
              style={inputStyle}
              onFocus={e => e.target.style.borderColor = '#2563EB'}
              onBlur={e  => e.target.style.borderColor = '#E2E8F0'}
            />
